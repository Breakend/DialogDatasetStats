# NOTE: the dataset walker was taken from the scripts provided with the dstc1 dataset
#       provided here: https://www.microsoft.com/en-us/research/event/dialog-state-tracking-challenge/
